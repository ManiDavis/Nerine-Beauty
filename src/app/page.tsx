                ...
                <div className="bg-cream-100 rounded-2xl p-7 border border-cream-400/50 flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      {t.date && (
                        <p className="font-sans text-xs text-navy-700/50 mt-0.5">{t.date}</p>
                      )}
                    </div>
                  </div>
                  {/* Review text */}
                  ...
                  {t.highlight && (
                    <p className="font-sans text-sm font-bold text-navy-800">{t.highlight}</p>
                  )}
                  {/* Fallback for old-style Sanity testimonials */}
                  {t.detail && !t.date && (
