...
import { treatments, categories, type Treatment } from "@/data/treatments";
    ...
    <main>
      ...
      <section className="relative bg-navy-800 pt-40 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          ...
          <motion.h1
            className="font-serif text-5xl sm:text-6xl text-cream-200 mb-6"
          ...
          >
            Every treatment is tailored to your individual skin, body and goals. We use only the finest professional products for results that speak for themselves.
          </motion.p>
        </div>
      </section>

      {/* ── CATEGORY FILTER ──────────────────────────────────── */}
      <section className="bg-cream-300 sticky top-[79px] z-20 border-b border-cream-400/60 shadow-sm">
      ...
      {/* ── TREATMENT LIST ───────────────────────────────────── */}
      <section className="relative bg-cream-300 min-h-screen overflow-hidden">
        <FlowerBackground color="#C4A05A" opacity={0.07} />
      ...
      {/* ── BOOK CTA ─────────────────────────────────────────── */}
      <section className="bg-navy-800 py-20 px-6 relative overflow-hidden">
